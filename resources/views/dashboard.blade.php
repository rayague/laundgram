    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <nav class="text-white bg-gray-800 sidebar">
                ...
                <li class="nav-item {{ request()->is('dashboard') ? 'bg-sky-500' : '' }}">
                ...
                <!-- Nav Item - Accueil -->
                <li class="nav-item {{ request()->is('accueil') ? 'bg-yellow-500' : '' }}">
                ...
                <!-- Nav Item - Commandes -->
                <li class="nav-item {{ request()->is('commande') ? 'bg-yellow-500' : '' }}">
                ...
                <li class="nav-item {{ request()->is('creation-objets') ? 'bg-yellow-500' : '' }}">
                    <a class="nav-link" href="creation-objets.html">
                ...
                <!-- Nav Item - Rappels -->
                <li class="nav-item {{ request()->is('rappels') ? 'bg-yellow-500' : '' }}">
                    <a class="nav-link" href="rappels.html">
                ...
                <li class="nav-item {{ request()->is('historiques') ? 'bg-yellow-500' : '' }}">
                    <a class="nav-link" href="historiques.html">
                ...
                <li class="nav-item {{ request()->is('statistiques') ? 'bg-yellow-500' : '' }}">
                ...
                <!-- Nav Item - Profil -->
                <li class="nav-item {{ request()->is('profil') ? 'bg-yellow-500' : '' }}">
