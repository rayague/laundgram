            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @if ($commandes->isEmpty())
                        <div class="p-3 mx-auto text-center bg-gray-200 rounded">

                            <p class="font-bold text-red-500">Aucune commande trouvée pour cette date.</p>
                        </div>
                    @else
                        <div class="overflow-x-auto bg-white rounded-lg shadow-md">
                            <table class="w-full border border-collapse table-auto">
                                <thead class="text-white bg-blue-600">
                                    <tr>
                                        <th class="px-4 py-3 text-left border border-blue-400">Numéro de la Facture
                                        </th>
                                        <th class="px-4 py-3 text-left border border-blue-400">Nom du Client</th>
                                        <th class="px-4 py-3 text-left border border-blue-400">Numéro de Téléphone
                                        </th>
                                        <th class="px-4 py-3 text-left border border-blue-400">Date de Retrait</th>
                                        <th class="px-4 py-3 text-left border border-blue-400">Montant de la
                                            Facture</th>
                                ...
                                <tbody>
                                    @foreach ($commandes as $commande)
                                        <tr class="hover:bg-blue-50">
                                            <td class="px-4 py-3 border border-blue-300">{{ $commande->numero }}
                                            </td>
                                            <td class="px-4 py-3 border border-blue-300">{{ $commande->client }}
                                            </td>
